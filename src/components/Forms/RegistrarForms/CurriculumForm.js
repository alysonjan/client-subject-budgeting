        ...
        <form onSubmit={(e) => onSubmit(e)}>
          <DialogContent>
            <TextField
              ...
              onChange={(e) => {
                setCurriculum_code(e.target.value)
              }}
              fullWidth
              required
            />
            ...
            <FormControl fullWidth>
              ...
              <Select
                ...
                value={college_code}
                onChange={(e) => {
                  setCollege_code(e.target.value)
                }}
              >
            ...
            <TextField type="hidden" value={subject_name}></TextField>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-evenly' }}>
              <TextField
                ...
                name="school_yr_from"
                onChange={(e) => {
                  setSchool_yr_from(e.target.value)
                }}
              />
              ...
              <TextField
                ...
                name="school_yr_to"
                onChange={(e) => {
                  setSchool_yr_to(e.target.value)
                }}
              />
            </div>
          </DialogContent>
